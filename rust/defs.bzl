...
def _rust_proto_library_impl(ctx):
    ...
    # Construct a label, assuming a monorepo, and compute the crate name.
    # Package and workspace root are only used then 1P crate renaming is enabled which
    # current onlys supports monorepos.
